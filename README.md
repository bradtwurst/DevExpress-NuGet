...
For example, if the assembly `DevExpress.Xpf.Ribbon.v14.2.dll` directly references `DevExpress.Data.v14.2.dll`, `DevExpress.Mvvm.v14.2.dll` and `DevExpress.Xpf.Core.v14.2.dll`, the NuGet specification will declare a dependency to each of the three NuGet packages corresponding to these assemblies:
    ...
    <package xmlns="http://schemas.microsoft.com/packaging/2012/06/nuspec.xsd">
      <metadata>
        ...
        <version>14.2.8.0</version>
        <!-- ... (omitted for brevity) -->
        <dependencies>
          <group targetFramework=".NETFramework4.0">
            <dependency id="Unofficial.DevExpress.Xpf.Core" version="14.2.8.0" />
            <dependency id="Unofficial.DevExpress.Data" version="14.2.8.0" />
            <dependency id="Unofficial.DevExpress.Mvvm" version="14.2.8.0" />
          </group>
       </dependencies>
      </metadata>
      <files>
 ...
 * **v14.2.8.0** - 2015-04-30
   **branched into v14.2 branch**
   - Contains NuGet specs for the DevExpress Components 14.2.8 released on June 23, 2015
